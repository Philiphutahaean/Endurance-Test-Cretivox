          ...
          <div className="about-container">
            <div className="container-text">
              <div className="container-inner-text1">
                <p ref={(el) => (text1 = el)}>Philip Jonathan</p>
              </div>
            ...
            <div
              ...
              ref={(el) => (p1 = el)}
            >
              I like something that can inspired me
              <br /> and make me feel insecure <br /> so i can be more keep my
              spirit to learn new thing.
            </div>
